...
public final class UpdateManager {
     ...
     */
    public void addTickStartCallback(LongConsumer callback) {
     ...
     */
    public void removeTickStartCallback(LongConsumer callback) {
     ...
     */
    public void addTickEndCallback(LongConsumer callback) {
     ...
     * @param callback the callback to remove
     */
    public void removeTickEndCallback(LongConsumer callback) {
