...
public interface EventHandler {
     ...
     */
    default <E extends Event> boolean addEventCallback(Class<E> eventClass, EventCallback<E> eventCallback) {
     ...
     */
    default <E extends Event> boolean removeEventCallback(Class<E> eventClass, EventCallback<E> eventCallback) {
        Check.notNull(eventClass, "Event class cannot be null");
        Check.notNull(eventCallback, "Event callback cannot be null");
        Collection<EventCallback> callbacks = getEventCallbacks(eventClass);
     ...
     */
    default <E extends Event & CancellableEvent> void callCancellableEvent(Class<E> eventClass,
                                                                           E event,
	...
	default <E extends Event> void runEvent(Collection<EventCallback> eventCallbacks, E event) {
