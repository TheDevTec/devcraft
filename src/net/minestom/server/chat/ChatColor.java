...
public final class ChatColor {
    ...
    private static final HashMap<Integer,ChatColor> idColorMap = new HashMap<>();
    private static final Map<String, ChatColor> colorCode = new HashMap<>();
    private static final HashMap<Character,ChatColor> legacyColorCodesMap = new HashMap<>();
    ...
    private ChatColor(byte r, byte g, byte b, int id, String codeName, boolean special) {
        this.empty = false;
        this.red = r;
        this.green = g;
        this.blue = b;
