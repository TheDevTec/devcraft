...
public class CollisionUtils {
     ...
     */
    public static boolean handlePhysics(Entity entity,
     ...
     */
    @NotNull
    public static Position applyWorldBorder(Instance instance,
                                            Position currentPosition, Position newPosition) {
