...
public class ChunkBatch implements InstanceBatch {
    ...
    // Need to be synchronized manually
    // block index - data
    private HashMap<Integer,Data> blockDataMap;
     ...
     */
    private void apply(Chunk chunk, long value) {
    ...
    private void updateChunk(ChunkCallback callback, boolean safeCallback) {
