...
public class InstanceContainer extends Instance {
    ...
    private synchronized void setBlock(int x, int y, int z, short blockStateId,
                                       CustomBlock customBlock, Data data) {
     ...
     * @param data         the {@link Data}, null if none
     */
    private void UNSAFE_setBlock(Chunk chunk, int x, int y, int z, short blockStateId,
                                 CustomBlock customBlock, Data data) {
    ...
    public void scheduleUpdate(int time, BlockPosition position) {
        ...
        new ServerRunnable() {
			public void run() {
	            ...
	            currentBlock.scheduledUpdate(InstanceContainer.this, position, getBlockData(position));
			}
		}.runLater(time);
    }
