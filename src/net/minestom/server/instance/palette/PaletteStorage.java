...
public class PaletteStorage implements PublicCloneable<PaletteStorage> {
    ...
    private HashMap<Short,Short>[] paletteBlockMaps;
    // chunk section - block id = palette index
    private HashMap<Short,Short>[] blockPaletteMaps;
	...
	private void init() {
        ...
        this.paletteBlockMaps = new HashMap[CHUNK_SECTION_COUNT];
        this.blockPaletteMaps = new HashMap[CHUNK_SECTION_COUNT];
    }
    ...
    public short[] getPalette(int section) {
    	HashMap<Short,Short> paletteBlockMap = paletteBlockMaps[section];
        return paletteBlockMap != null ? array(paletteBlockMap.values()) : null;
    }
    
    private final short[] array(Collection<Short> s) {
    	short[] d = new short[s.size()];
    	int i = 0;
    	for(short f : s)d[i++]=f;
    	return d;
    }
    ...
    private short getPaletteIndex(int section, short blockId) {
        ...
        HashMap<Short,Short> blockPaletteMap = blockPaletteMaps[section];
        ...
        if (!blockPaletteMap.containsKey(blockId)) {
            ...
            @SuppressWarnings("unchecked")
			final short paletteIndex = (short) ((short) ((Entry<Short,Short>)paletteBlockMap.entrySet().toArray()[paletteBlockMap.size()]).getKey() + 1);
    ...
    private static HashMap<Short,Short> createPaletteBlockMap() {
    	HashMap<Short,Short> map = new HashMap<>();
        map.put((short) 0, (short) 0);
        return map;
    }

    private static HashMap<Short,Short> createBlockPaletteMap() {
    	HashMap<Short,Short> map = new HashMap<>();
        map.put((short) 0, (short) 0);
        return map;
    }
