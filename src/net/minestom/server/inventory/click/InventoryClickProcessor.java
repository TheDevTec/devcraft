...
import net.minestom.server.fastutil.Int2IntFunction;
import net.minestom.server.fastutil.Int2ObjectFunction;
...
public class InventoryClickProcessor {
    ...
    // Dragging maps
    private final Map<Player, HashSet<Integer>> leftDraggingMap = new HashMap<>();
    private final Map<Player, HashSet<Integer>> rightDraggingMap = new HashMap<>();

    public InventoryClickResult leftClick(Inventory inventory, Player player, int slot,
    ...
    public InventoryClickResult rightClick(Inventory inventory, Player player, int slot,
                                           ItemStack clicked, ItemStack cursor) {
    ...
    public InventoryClickResult changeHeld(Inventory inventory, Player player, int slot, int key,
                                           ItemStack clicked, ItemStack cursor) {
    ...
    private InventoryClickResult startCondition(Inventory inventory, Player player, int slot,
