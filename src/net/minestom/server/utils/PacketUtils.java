...
public final class PacketUtils {
     ...
     */
    public static void compressBuffer(Deflater deflater, byte[] buffer,
                                      ByteBuf packetBuffer, ByteBuf compressionTarget,
        ...
        if (packetLength < MinecraftServer.getCompressionThreshold()) {
            ...
            final Runnable compressor = () -> {
                ...
                deflater.setInput(packetBuffer.nioBuffer().array());
                deflater.finish();
     ...
     */
    public static ByteBuf createFramedPacket(ServerPacket serverPacket, boolean directBuffer) {
