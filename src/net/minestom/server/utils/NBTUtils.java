...
public final class NBTUtils {
    ...
    public static void writeEnchant(NBTCompound nbt, String listName,
                                    Map<Enchantment, Short> enchantmentMap) {
	...
	public static NBT toNBT(Object value, Class type, boolean supportDataType) {
	...
	public static Object fromNBT(NBT nbt) {
