...
public final class ChunkUtils {
     ...
     */
    public static void optionalLoadAll(Instance instance, long[] chunks,
                                       ChunkCallback eachCallback, ChunkCallback endCallback) {
     ...
     */
    public static long[] getChunksInRange(Position position, int range) {
        range = range * 2;
    ...
    public static long[] getNeighbours(Instance instance, int chunkX, int chunkZ) {
        ...
        long[] array = new long[chunks.size()];
        int c = 0;
        for(long l : chunks)array[c++]=l;
        return array;
    }
