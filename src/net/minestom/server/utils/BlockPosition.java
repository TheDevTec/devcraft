...
public class BlockPosition implements PublicCloneable<BlockPosition> {
     ...
     */
    public int getManhattanDistance(BlockPosition blockPosition) {
     ...
     * @return the distance between 'this' and {@code blockPosition}
     */
    public int getDistanceSquared(BlockPosition blockPosition) {
     ...
     */
    public void copyCoordinates(BlockPosition blockPosition) {
