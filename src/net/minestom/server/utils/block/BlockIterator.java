...
public class BlockIterator implements Iterator<BlockPosition> {
     ...
     *
     */
    public BlockIterator(Vector start, Vector direction, float yOffset, int maxDistance) {
    ...
    private boolean blockEquals(BlockPosition a, BlockPosition b) {
    ...
    private double getXPosition(Vector direction, Vector position, BlockPosition block) {
        return getPosition(direction.getX(), position.getX(), block.getX());
    }

    private double getYPosition(Vector direction, Vector position, BlockPosition block) {
        return getPosition(direction.getY(), position.getY(), block.getY());
    }

    private double getZPosition(Vector direction, Vector position, BlockPosition block) {
     ...
     *     unloaded chunks. A value of 0 indicates no limit
     */
    public BlockIterator(Position pos, float yOffset, int maxDistance) {
    ...
    public BlockIterator(Position pos, float yOffset) {
    ...
    public BlockIterator(Position pos) {
        this(pos, 0f);
    }
