...
public class EntityFinder {
    ...
    public EntityFinder setStartPosition(Position startPosition) {
     ...
     */
    @NotNull
    public List<Entity> find(Instance instance, Entity self) {
     ...
     */
    @Nullable
    public Player findFirstPlayer(Instance instance, Entity self) {
    ...
    private static class ToggleableMap<T> extends HashMap<T, Boolean> {
    ...
    @NotNull
    private static List<Entity> findTarget(Instance instance, TargetSelector targetSelector,
                                           Position startPosition, Entity self) {
        ...
        if (targetSelector == TargetSelector.NEAREST_PLAYER) {
            ...
            final Player player = instancePlayers.stream().skip(index).findFirst().orElseThrow(null);
    ...
    private static <T> boolean filterToggleableMap(Entity entity, T value, ToggleableMap<T> map) {
        if (!(entity instanceof Player))
            return false;
