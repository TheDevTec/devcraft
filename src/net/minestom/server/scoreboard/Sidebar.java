...
public class Sidebar implements Scoreboard {
    ...
    private final ArrayList<Integer> availableColors = new ArrayList<>();
     ...
     */
    public void updateLineContent(String id, JsonMessage content) {
    ...
    public static class ScoreboardLine {
        ...
        private void retrieveName(ArrayList<Integer> colors) {
            synchronized (colors) {
                this.colorName = colors.remove(0);
            }
        }
        ...
        private void returnName(ArrayList<Integer> colors) {
            synchronized (colors) {
