...
public interface NavigableEntity {
     ...
     */
    default void moveTowards(Position direction, float speed) {
     ...
     */
    default boolean setPathTo(Position position, boolean bestEffort) {
        ...
        IPath path = pathFinder.initiatePathTo(
                (double)targetPosition.getX(),
                (double)targetPosition.getY(),
                (double)targetPosition.getZ(),
                bestEffort);
        setPath(path);
     ...
     */
    default boolean setPathTo(Position position) {
     ...
     */
    default void setPathfindingPriority(SchedulingPriority schedulingPriority) {
        final HydrazinePathFinder pathFinder = getPathFinder();
        if (pathFinder != null) {
     ...
     */
    @Deprecated
    void setPathPosition(Position path);
