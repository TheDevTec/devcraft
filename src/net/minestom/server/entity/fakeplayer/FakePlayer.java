...
public class FakePlayer extends Player {
     ...
     */
    private FakePlayer(UUID uuid, String username,
                       FakePlayerOption option,
                       Consumer<FakePlayer> spawnCallback) {
    ...
    public static void initPlayer(UUID uuid, String username,
                                  FakePlayerOption option, Consumer<FakePlayer> spawnCallback) {
     ...
     * @param spawnCallback the optional callback called when the fake player first spawn
     */
    public static void initPlayer(UUID uuid, String username, Consumer<FakePlayer> spawnCallback) {
