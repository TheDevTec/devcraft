...
public class Player extends LivingEntity implements CommandSender {
     ...
     */
    protected void init(Instance spawnInstance) {
     ...
     */
    public void setInstance(Instance instance, Position spawnPosition) {
     ...
     */
    private void spawnPlayer(Instance instance, Position spawnPosition,
     ...
     * @param pitch         the pitch of the sound, between 0.5 and 2.0
     */
    public void playSound(String identifier, SoundCategory soundCategory, int x, int y, int z, float volume, float pitch) {
     ...
     */
    public void sendHeaderFooter(JsonMessage header, JsonMessage footer) {
     ...
     */
    private void sendTitle(JsonMessage text, TitlePacket.Action action) {
     ...
     * @see #sendTitleTime(int, int, int) to specify the display time
     */
    public void sendTitleSubtitleMessage(JsonMessage title, JsonMessage subtitle) {
     ...
     * @see #sendTitleTime(int, int, int) to specify the display time
     */
    public void sendTitleMessage(JsonMessage title) {
        sendTitle(title, TitlePacket.Action.SET_TITLE);
    }
     ...
     * @see #sendTitleTime(int, int, int) to specify the display time
     */
    public void sendSubtitleMessage(JsonMessage subtitle) {
        sendTitle(subtitle, TitlePacket.Action.SET_SUBTITLE);
    }
     ...
     * @see #sendTitleTime(int, int, int) to specify the display time
     */
    public void sendActionBarMessage(JsonMessage actionBar) {
     ...
     */
    public void openBook(WrittenBookMeta bookMeta) {
        // Set book in offhand
    ...
    @Override
    protected void onAttributeChanged(final AttributeInstance attributeInstance) {
     ...
     */
    public void setDisplayName(JsonMessage displayName) {
    ...
    private void facePosition(FacePoint facePoint, Position targetPosition,
                              Entity entity, FacePoint targetPoint) {
     ...
     */
    public void refreshVisibleChunks(Chunk newChunk) {
     ...
     */
    public void refreshVisibleEntities(Chunk newChunk) {
    ...
    @Override
    public void teleport(Position position, long[] chunks, Runnable callback) {
     ...
     */
    public void kick(JsonMessage text) {
     ...
     */
    public void setTargetBlock(CustomBlock targetCustomBlock, BlockPosition targetBlockPosition,
                               Set<Player> breakers) {
	...
	@Override
	public <E extends Event> void runEvent(@SuppressWarnings("rawtypes") Collection<EventCallback> eventCallbacks, E event) {
