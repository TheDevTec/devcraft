...
public final class CommandManager {
     ...
     * @throws IllegalStateException if a command with the same name already exists
     */
    public synchronized void register(CommandProcessor commandProcessor) {
     ...
     */
    public void setUnknownCommandCallback(CommandCallback unknownCommandCallback) {
    ...
    private void createCommand(CommandSender sender,
                               ...
                               ArrayList<Integer> cmdChildren,
                               String name,
                               Collection<CommandSyntax> syntaxes,
                               ArrayList<Integer> rootChildren) {
