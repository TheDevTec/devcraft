...
public class BiomeTint {
    ...
    private enum GrassTint {
        ...
        PLAINS(0x91BD59), OCEAN(0x8EB971), MUSHROOM_FIELDS(0x55C93F),
    ...
    private enum FoliageTint {
        ...
        FOREST(0x59AE30), BIRCH_FOREST(0x6BA941), DARK_FOREST(0x59AE30),
        PLAINS(0x77AB2F), OCEAN(0x71A74D), MUSHROOM_FIELDS(0x2BBB0F),
    ...
    private enum WaterTint {
        ...
        LUKEWARM_OCEAN(0x45ADF2), WARM_OCEAN(0x43D5EE);
    ...
    private enum WaterFogTint {
        DEFAULT(0x050533), COLD_OCEAN(0x050533), FROZEN_OCEAN(0x050533),
        LUKEWARM_OCEAN(0x041633), WARM_OCEAN(0x041F33);

        int type;

        WaterFogTint(int type) {
            this.type = type;
        }
    ...
    public static final BiomeEffects BADLANDS = BiomeEffects.builder()
            ...
            .waterFogColor(WaterFogTint.DEFAULT.type)
    ...
    public static final BiomeEffects WARM_OCEAN = BiomeEffects.builder()
            .skyColor(SkyTint.WARM.type)
            .fogColor(FogTint.WARM.type)
            .waterColor(WaterTint.WARM_OCEAN.type)
            .waterFogColor(WaterFogTint.WARM_OCEAN.type)
            .grassColor(GrassTint.OCEAN.type)
            .foliageColor(FoliageTint.OCEAN.type)
            .build();

    public static final BiomeEffects LUKEWARM_OCEAN = BiomeEffects.builder()
            .skyColor(SkyTint.LUSH.type)
            .fogColor(FogTint.LUSH.type)
            .waterColor(WaterTint.LUKEWARM_OCEAN.type)
            .waterFogColor(WaterFogTint.LUKEWARM_OCEAN.type)
            .grassColor(GrassTint.OCEAN.type)
            .foliageColor(FoliageTint.OCEAN.type)
            .build();

    public static final BiomeEffects COLD_OCEAN = BiomeEffects.builder()
            .skyColor(SkyTint.COLD.type)
            .fogColor(FogTint.COLD.type)
            .waterColor(WaterTint.COLD_OCEAN.type)
            .waterFogColor(WaterFogTint.COLD_OCEAN.type)
            .grassColor(GrassTint.OCEAN.type)
            .foliageColor(FoliageTint.OCEAN.type)
            .build();

    public static final BiomeEffects FROZEN_OCEAN = BiomeEffects.builder()
            .skyColor(SkyTint.SNOWY.type)
            .fogColor(FogTint.SNOWY.type)
            .waterColor(WaterTint.FROZEN_OCEAN.type)
            .waterFogColor(WaterFogTint.FROZEN_OCEAN.type)
            .grassColor(GrassTint.OCEAN.type)
            .foliageColor(FoliageTint.OCEAN.type)
            .build();
}
